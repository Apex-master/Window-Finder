...
int main(int, char**)
{
    ...
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, L"Window Finder", NULL };
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Window Finder", WS_OVERLAPPEDWINDOW, 100, 100, 1480, 800, NULL, NULL, wc.hInstance, NULL);
